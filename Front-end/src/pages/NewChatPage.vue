          ...
          <div class="chat-box q-pa-md">
            ...
            <div class="messages">
              ...
              <div v-if="botTyping" class="typing-indicator">
                ...
                <span class="typing-text">Creating a new conversation for you...</span>
              </div>
            </div>
    ...
    if (this.message.trim()) {
      ...
      try {
        ...
        const response = await api.post(
          '/ai/chat/createchatorupdateconvo',
        ...
        if (response.status===200){
          ...
          setTimeout(() => {
  this.$router.push({ name: 'chat', params: { chatId: this.chatid } }) // Access chatid using ref value
}, 1000)
